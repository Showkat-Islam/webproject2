...
<footer class="footer-area home-page-<?php echo e(get_static_option('home_page_variant')); ?> <?php if(request()->routeIs('homepage')): ?> is-homepage <?php else: ?> inner-page <?php endif; ?>">
    ...
    <div class="footer-top padding-top-100 padding-bottom-65" style="background:#54585B;border-top: 8px solid #7BC869;padding-top:0;">
        <div class="container">
            <div class="row">
    ...
    <?php endif; ?>
    <div class="copyright-area" style="background:#7BC869;color:white; text-align:left; border-top: 5px solid #E6E6E6;">
        <div class="container" >
...
</html><?php /**PATH C:\xampp\htdocs\project\health\@core\resources\views/frontend/partials/footer.blade.php ENDPATH**/ ?>